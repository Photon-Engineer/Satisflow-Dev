...
export const ITEMS = {
    ...
    PackWater: new Item("Pack Water", CATS.MATERIAL),
    ...
    PackOil: new Item("Pack Oil", CATS.FUEL),
    PackHeavyOil: new Item("Pack Heavy Oil Residue", CATS.FUEL),
    SolidBiofuel: new Item("Solid Biofuel", CATS.FUEL),
    PackFuel: new Item("Pack Fuel", CATS.FUEL),
    PackBiofuel: new Item("Pack Liquid Biofuel", CATS.FUEL),
    PackTurbofuel: new Item("Pack Turbofuel", CATS.FUEL),
...
export const AssemblerRecipes = [
	...
	new Recipe("Encased Uranium Cell",STRUC.ASSM).addInput(ITEMS.UraniumPellet,40).addInput(ITEMS.Concrete,9).addOutput(ITEMS.UraniumCell,10),
...
export const ManufacturerRecipes = [
	...
	new Recipe("Nuclear Fuel Rod",STRUC.MANU).addInput(ITEMS.UraniumCell,10).addInput(ITEMS.EncasedIndustrialBeam,1.2).addInput(ITEMS.ElectromagneticControlRod,2).addOutput(ITEMS.NuclearFuelRod,0.4),
	...
	new Recipe("Alt: Nuclear Fuel Unit",STRUC.MANU).addInput(ITEMS.UraniumCell,10).addInput(ITEMS.ElectromagneticControlRod,2).addInput(ITEMS.CrystalOscillator,0.6).addInput(ITEMS.Beacon,1.2).addOutput(ITEMS.NuclearFuelRod,0.6),
	...
	new Recipe("Alt: Infused Uranium Cell",STRUC.MANU).addInput(ITEMS.UraniumPellet,20).addInput(ITEMS.Sulfur,22.5).addInput(ITEMS.Silica,22.5).addInput(ITEMS.Quickwire,37.5).addOutput(ITEMS.UraniumCell,17.5),
